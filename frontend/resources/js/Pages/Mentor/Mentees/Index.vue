      ...
      <Card class="overflow-hidden border-none shadow-sm">
          ...
          <table class="w-full text-left border-collapse">
            <thead>
              <tr class="bg-slate-50/50 dark:bg-slate-900/50 border-b border-slate-100 dark:border-slate-800">
                <th class="px-8 py-5 text-xs font-bold text-slate-400 font-medium">Nama Mentee</th>
                <th class="px-8 py-5 text-xs font-bold text-slate-400 font-medium">Posisi Magang</th>
                <th class="px-8 py-5 text-xs font-bold text-slate-400 font-medium text-center">Status</th>
                <th class="px-8 py-5 text-xs font-bold text-slate-400 font-medium">Bergabung Pada</th>
              ...
              <tr v-for="mentee in mentees.data" :key="mentee.id" class="hover:bg-slate-50/30 dark:hover:bg-slate-900/20 transition-colors group">
                ...
                <td class="px-8 py-6 text-right">
                  <Link 
                    ...
                    class="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl text-xs font-bold hover:bg-primary-600 hover:text-white transition-colors active-press"
                  >
                    Detail
        ...
        <div v-if="mentees.data.length > 0" class="px-8 py-6 bg-slate-50/30 dark:bg-slate-900/30 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
           ...
           <div class="flex gap-2">
              <button disabled class="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl text-xs font-bold text-slate-300 font-medium">Kembali</button>
              <button disabled class="px-4 py-2 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-xl text-xs font-bold text-slate-300 font-medium">Lanjut</button>
           </div>
        </div>
      </Card>
    </div>
