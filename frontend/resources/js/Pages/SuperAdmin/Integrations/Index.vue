  ...
  <DashboardLayout>
    ...
    <div v-else class="space-y-10">
      <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <button 
          class="flex items-center gap-2 px-6 py-3 bg-primary-600 text-white rounded-2xl text-sm font-bold hover:bg-primary-700 transition-colors shadow-lg shadow-primary-500/20 active:scale-95"
...
:class="[
              ...
              <div class="flex-1 space-y-8">
                 <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                       <label class="text-xs font-bold text-slate-400 font-medium">Nama Integrasi</label>
                       <input 
                    ...
                    <div class="space-y-2">
                       <label class="text-xs font-bold text-slate-400 font-medium">Provider</label>
                 ...
                 <div class="flex items-center justify-between pt-4 border-t border-slate-50 dark:border-slate-800">
                    <div class="flex gap-3">
                       <button 
                         ...
                         class="flex items-center gap-2 px-6 py-3 bg-primary-600 text-white rounded-xl text-xs font-bold hover:bg-primary-700 transition-colors"
                       ...
                       <button 
                         :disabled="processing === integration.id"
                         class="flex items-center gap-2 px-6 py-3 bg-red-50 text-red-600 rounded-xl text-xs font-bold hover:bg-red-600 hover:text-white transition-colors"
                    ...
                    <button 
                      :disabled="processing === integration.id"
                      class="flex items-center gap-2 px-6 py-3 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 rounded-xl text-xs font-bold hover:bg-primary-600 hover:text-white transition-colors"
    ...
    <Modal :show="showCreateModal" max-width="md" @close="showCreateModal = false">
       <div class="p-8">
          ...
          <form class="space-y-6" @submit.prevent="submitCreate">
             <div class="space-y-2">
                <label class="text-xs font-bold text-slate-400 font-medium">Nama Layanan</label>
