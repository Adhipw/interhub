...
<template>
    <div class="px-2 py-1">
        <div class="group relative">
            <button class="w-full flex items-center justify-between gap-3 px-4 py-2.5 bg-slate-50 dark:bg-neutral-800 hover:bg-slate-100 dark:hover:bg-neutral-700 rounded-xl transition-all border border-slate-100 dark:border-neutral-700 group-hover:border-primary-400">
            ...
            <div
                class="absolute left-0 w-full bg-white dark:bg-neutral-900 rounded-xl shadow-2xl border border-slate-100 dark:border-neutral-800 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-[100] overflow-hidden"
